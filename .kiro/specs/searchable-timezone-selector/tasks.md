...
- [ ] 1. Add `formatTimezoneOffset` and enrich `getTimezoneOptions()` in `src/dateFormat.ts`
  - [ ] 1.1 Implement the `formatTimezoneOffset(timeZone: string, at?: Date): string | null` pure helper
    ...
    - _Requirements: 1.5_
  - [ ] 1.2 Enrich `getTimezoneOptions()` labels with the offset
  ...
  - [ ]* 1.3 Write property test for the offset formatter (Property 4)
...
- [ ] 2. Implement the pure `filterTimezoneOptions` helper
  - [ ] 2.1 Add `filterTimezoneOptions(options, query)` to `src/components/timezoneCombobox.ts`
  ...
  - [ ]* 2.2 Write property test for filter correctness (Property 1)
  ...
  - [ ]* 2.3 Write property test for empty-query behavior (Property 2)
...
- [ ] 4. Build the `createTimezoneCombobox` component
  - [ ] 4.1 Build DOM structure and `ComboboxState` with a single `render()`
  ...
  - [ ] 4.2 Implement `setValue`/`getValue` value-to-display mapping
  ...
  - [ ]* 4.3 Write property test for value-to-display mapping (Property 3)
  ...
  - [ ] 4.4 Implement filtering, rendering, and the "no matches" row
  ...
  - [ ]* 4.5 Write property test for rendered row count (Property 6)
  ...
  - [ ] 4.6 Implement open/close behavior
  ...
  - [ ] 4.7 Implement pointer selection
  ...
  - [ ] 4.8 Implement keyboard navigation and commit with a pure highlight-step helper
  ...
  - [ ]* 4.9 Write property test for highlight navigation wrap (Property 5)
  ...
  - [ ] 4.10 Implement invalid-value / blur handling and commit-membership guard
  ...
  - [ ]* 4.11 Write property test for commit membership (Property 7)
  ...
  - [ ] 4.12 Wire full ARIA and implement `destroy()`
...
- [ ] 6. Set up the property-test harness
  - [ ] 6.1 Create a dependency-free property-test harness `.ts` file
...
- [ ] 7. Integrate the combobox into `src/screens/settingsScreen.ts`
  - [ ] 7.1 Replace the timezone `buildSelect` block with `createTimezoneCombobox`
  ...
  - [ ] 7.2 Wire `onSelect` to the save / preview / revert+toast / no-op-skip flow
  ...
  - [ ] 7.3 Update external re-sync and cleanup wiring
...
- [ ] 8. Add combobox CSS to `app.css`
  - [ ] 8.1 Add `.combobox*` classes aligned with existing form styling
...
- [ ] 9. Final verification
  - [ ] 9.1 Run static + property verification
